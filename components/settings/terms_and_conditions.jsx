...
import get_computed_style from "../../assets/styles/terms_and_conditions";
...
const TermsAndConditions = () => {
  ...
  return (
    ...
    >
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Interpretation and Definitions</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Acknowledgment</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Links to Other Websites</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Termination</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Limitation of Liability</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Governing Law</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Disputes Resolution</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>For European Union (EU) Users</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>United States Legal Compliance</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Severability</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Waiver</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Translation Interpretation</Text>
        <Text style={styles.terms_content}>
      ...
      <View style={styles.terms}>
        <Text style={styles.terms_title}>Contact Us</Text>
        <Text style={styles.terms_content}>
