...
const fetch_weather_by_geolocation = async (latitude, longitude) => {
  const api = `${OPEN_WEATHER_MAP_BASE_URL}/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=${OPEN_WEATHER_MAP_API_KEY}&units=metric`;
...
const fetch_weather_by_city = async (city) => {
  const api = `${OPEN_WEATHER_MAP_BASE_URL}/data/2.5/weather?q=${city}&appid=${OPEN_WEATHER_MAP_API_KEY}&units=metric`;
  const fetch_weather_forecast = await fetch(api);
  const weather_forecast = await fetch_weather_forecast.json();
...
const fetch_hourly_weather_by_geolocation = async (latitude, longitude) => {
  const api = `${OPEN_WEATHER_MAP_BASE_URL}/data/2.5/forecast?lat=${latitude}&lon=${longitude}&appid=${OPEN_WEATHER_MAP_API_KEY}&units=metric`;
  const fetch_weather_forecast = await fetch(api);
  const weather_forecast = await fetch_weather_forecast.json();
...
const fetch_hourly_weather_by_city = async (city) => {
  const api = `${OPEN_WEATHER_MAP_BASE_URL}/data/2.5/forecast?q=${city}&appid=${OPEN_WEATHER_MAP_API_KEY}&units=metric`;
  const fetch_weather_forecast = await fetch(api);
  const weather_forecast = await fetch_weather_forecast.json();
